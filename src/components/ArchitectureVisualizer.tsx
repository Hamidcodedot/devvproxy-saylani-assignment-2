...
const STAGES: Stage[] = [
  ...
  },
  {
    ...
    badge: 'Smart TTL + Volatility Shield',
    latency: '< 0.05ms',
    description: 'Scans prompts for real-time volatility (crypto prices, weather) to bypass stale data automatically. Invariant prompts return in 0ms with 100% cost elimination.',
    techDetails: 'Supports RFC X-Devv-Cache-Control, custom TTLs, and tenant-scoped SHA-256 keys.',
    icon: Zap,
    sampleTransformation: {
      inputLabel: 'Volatility Scan & Query',
      inputValue: '"What is the price of Bitcoin today?"',
      outputLabel: 'Smart Policy Decision',
      outputValue: 'X-Devv-Cache: BYPASS (volatile_detected)\nX-Devv-Cache-Policy: volatile (Fresh Upstream Data Guaranteed)',
      statusBadge: 'Zero Stale Data',
    },
  },
  {
    id: 'router',
